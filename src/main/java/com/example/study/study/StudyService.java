...
public class StudyService {
     ...
     */
        List<StudyPost> posts = studyPostRepository.findByWriterIdOrderByIdDesc(memberId);
        Map<Long, Long> counts = acceptedCounts(posts.stream().map(StudyPost::getId).toList());
        return posts.stream()
